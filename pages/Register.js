                    ...
                    <div className="w-3/5 justify-center items-center bg-red text-white rounded-tr-2xl rounded-br-2xl py-24 px-12">
                        <div className="flex flex-col items-center">
                            ...
                            <div className="bg-lightgrey rounded-lg h-10 w-80 p-2 flex items-center m-3">
                                <input type='text' name='text' placeholder='First Name' className='bg-lightgrey outline-none text-sm text-black flex-1' />
                            </div>

                            <div className="bg-lightgrey rounded-lg h-10 w-80 p-2 flex items-center m-3">
                                <input type='text' name='text' placeholder='Last Name' className='bg-lightgrey outline-none text-sm text-black flex-1' />
                            </div>

                            <div className="bg-lightgrey rounded-lg h-10 w-80 max-80 p-2 flex items-center m-3"><FaRegEnvelope className='text-grey m-2' />
                                <input type='email' name='email' placeholder='E-mail' className='bg-lightgrey outline-none text-sm text-black flex-1' />
                            </div>

                            <div className="bg-lightgrey rounded-lg h-10 w-80 p-2 flex items-center m-3"><MdLockOutline className='text-grey m-2' />
