...
export default function Login() {
    ...
    const login = async (e) => {
        ...
        if (userLogin.message === "Invalid Credentials") {
            router.push('/LogIn')
            swal({
                title: "Error!",
    ...
    return (
        <div className="flex flex-col items-center justify-center w-screen h-screen flex-1 px-20 text-center bg-white">
            ...
            <div className="bg-white rounded-2xl shadow-2xl flex w-screen lg:w-2/3 lg:max-w-4xl md:max-w-xl flex-col lg:flex-row">
