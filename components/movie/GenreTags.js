...
const GenreTags = ({ genres }) => {
    ...
    return (
        <div className="absolute opacity-0 -translate-y-full w-full z-10 bg-white flex justify-center items-center gap-2 h-10 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500">
            {tags}
        </div>
    )
}
